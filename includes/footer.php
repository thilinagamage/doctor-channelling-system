        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-section">
                    <h3>DoctorChannelling</h3>
                    <p>Your trusted platform for booking doctor appointments online in Sri Lanka.</p>
                ...
                <div class="footer-section">
                    ...
                    <ul class="contact-info">
                        ...
                        <li><i class="fas fa-envelope"></i> info@doctorchannelling.lk</li>
                        <li><i class="fas fa-map-marker-alt"></i> Colombo, Sri Lanka</li>
                    </ul>
                </div>
            </div>
            <div class="footer-bottom">
                <p>&copy; <?php echo date('Y'); ?> DoctorChannelling. All rights reserved.</p>
